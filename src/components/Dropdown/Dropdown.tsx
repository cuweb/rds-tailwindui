...
export const Dropdown = ({
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button
          className={` ${shawdowStyle} ${borderStyle} inline-flex w-full justify-center rounded-md  bg-white px-4 py-2 text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-100`}
        >
          {button}
          {!noArrow && (
            <ChevronDownIcon
