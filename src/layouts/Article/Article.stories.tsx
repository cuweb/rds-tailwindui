...
const DefaultTemplate: Story<ArticleProps> = args => (
  <>
    <Column>
      <Article bgColor={args.bgColor}>
        <h2>H2 Heading</h2>
...
const MarkupTemplate: Story<ArticleProps> = args => (
  <Column>
    <Article bgColor={args.bgColor} content={data} />
  </Column>
);
...
Markup.storyName = 'Markup as Prop';
